...
export const WS_CONNECTION_SUCCESS_ORDERS_USER: "WS_CONNECTION_SUCCESS_ORDERS_USER" =
  "WS_CONNECTION_SUCCESS_ORDERS_USER";
export const WS_CONNECTION_ERROR_ORDERS_USER: "WS_CONNECTION_ERROR_ORDERS_USER" =
  "WS_CONNECTION_ERROR_ORDERS_USER";
export const WS_CONNECTION_CLOSED_ORDERS_USER: "WS_CONNECTION_CLOSED_ORDERS_USER" =
