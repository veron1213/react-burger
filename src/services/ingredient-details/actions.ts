...
export const addIngredientDetails: AppThunk =
  (detail: IngredientDetailType) => (dispatch: AppDispatch) => {
    dispatch(addIngredientDetailsAction(detail));
  };

export const removeIngredientDetails: AppThunk =
