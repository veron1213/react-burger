...
export const userRegistrationSuccessAction =
...
export const userRegistrationErrorAction = (
  payload: string
...
export const userRegistration: AppThunk =
...
export const forgotPassword: AppThunk =
  (form: { email: string }) => (dispatch: AppDispatch) => {
...
export const resetPassword: AppThunk =
  (form: { token: string; password: string }) => (dispatch: AppDispatch) => {
...
export const authorizationErrorAction = (
  payload: string
...
export const updateInformation: AppThunk =
...
export const updateTokenErrorAction = (
  payload: string
