...
export const orderNumberLoadSuccessAction = (payload: number): IOrderNumberLoadSuccessAction => ({
...
export const orderNumberLoadErrorAction = (payload: string): IOrderNumberLoadErrorAction => ({
...
export const loadOrder: AppThunk = (ingredients: string[]) => (dispatch: AppDispatch) => {
