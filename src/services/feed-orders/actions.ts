...
export const WS_CONNECTION_START_FEED_ORDERS: 'WS_CONNECTION_START_FEED_ORDERS' = 'WS_CONNECTION_START_FEED_ORDERS';
export const WS_CONNECTION_SUCCESS_FEED_ORDERS: 'WS_CONNECTION_SUCCESS_FEED_ORDERS' = 'WS_CONNECTION_SUCCESS_FEED_ORDERS';
export const WS_CONNECTION_ERROR_FEED_ORDERS: 'WS_CONNECTION_ERROR_FEED_ORDERS' = 'WS_CONNECTION_ERROR_FEED_ORDERS';
export const WS_CONNECTION_CLOSED_FEED_ORDERS: 'WS_CONNECTION_CLOSED_FEED_ORDERS' = 'WS_CONNECTION_CLOSED_FEED_ORDERS';
...
export const wsConnectionStartAction = (url: string): IWSConnectionStartFeedOrdersAction => ({
