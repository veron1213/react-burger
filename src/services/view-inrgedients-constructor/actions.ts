...
export const AddIngredientsConstructorAction = (
  payload: IngredientConstructorType
): IAddIngredientsConstructorAction => ({
  type: ADD_INGREDIENTS_CONSTRUCTOR,
  payload,
});

export const addIngredientsConstructor =
  (ingredient: IngredientConstructorType) => (dispatch: AppDispatch) => {
...
export const replaceIngredientsAction = (
  payload: any
...
export const replaceIngredients =
  (numbersObject: any) => (dispatch: AppDispatch) => {
...
export const addBunConstructorAction = (
  payload: IngredientType | null
...
export const addBunConstructor =
  (bun: IngredientType | null) => (dispatch: AppDispatch) => {
...
export const removeIngredientsConstructorAction = (
  payload: string
...
export const removeIngredientsConstructor =
  (key: string) => (dispatch: AppDispatch) => {
